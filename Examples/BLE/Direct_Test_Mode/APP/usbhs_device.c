...
const uint8_t HS_Return1[2] = {0x31,0x00};
const uint8_t HS_Return2[2] = {0xC3,0x00};
const uint8_t HS_Return3[2] = {0x9F,0xEE};
...
//                                        len = 7;
                            ...
                            else if( USBHS_SetupReqType == 0xC0 )
                            {
                                if(USBHS_SetupReqCode==0x5F)
                                {
                                  pUSBHS_Descr = HS_Return1;
                                  len = sizeof(HS_Return1);
                                }
                                else if(USBHS_SetupReqCode==0x95)
                                {
                                  if((pUSBHS_SetupReqPak->wValue)==0x18)
                                  {
                                    pUSBHS_Descr = HS_Return2;
                                    len = sizeof(HS_Return2);
                                  }
                                  else if((pUSBHS_SetupReqPak->wValue)==0x06)
                                  {
                                    pUSBHS_Descr = HS_Return3;
                                    len = sizeof(HS_Return3);
                                  }
                                }
                                else
                                {
